...
//EDIT
void rrt_restart_t::setup_planning()
{
...
void rrt_restart_t::restart_planning()
{
	delete metric;
	metric = new graph_nearest_neighbors_t();
	metric->set_system(system);
...
void rrt_restart_t::add_point_to_metric(tree_node_t* state)
{
...
void rrt_restart_t::random_sample()
{
...
void rrt_restart_t::nearest_vertex()
{
	system->copy_state_point(metric_query->point,sample_state);
	double distance;
...
void rrt_restart_t::add_to_tree()
{

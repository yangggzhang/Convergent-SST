...
{
	std::stringstream s;
    s<<"/home/parallels/Documents/Convergent-SST/c_sst_in_cpp/data/hill/"<<params::planner<<"_"<<image_counter<<"_tree.svg";
...
{
	std::stringstream s;
    s<<"/home/parallels/Documents/Convergent-SST/c_sst_in_cpp/data/hill/"<<params::planner<<"_"<<image_counter<<"_node.svg";
    std::string dir(s.str());
    svg::Dimensions dimensions(params::image_width, params::image_height);
    svg::Document doc(dir, svg::Layout(dimensions, svg::Layout::BottomLeft));
    sorted_nodes.clear();

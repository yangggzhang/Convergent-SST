...
public:
	 ...
	 */
	//ADD_KAIWEN
	rrt_t(system_t* in_system, unsigned in_number_of_particles, double in_particle_radius, unsigned in_number_of_control) : planner_t(in_system, in_number_of_particles, in_particle_radius, in_number_of_control)
	{
